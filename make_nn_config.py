...
ecoli_positive_A = TargetRegions("../marginAlign/cPecan/tests/ecoli_positive_A.tsv")
ecoli_positive_T = TargetRegions("../marginAlign/cPecan/tests/ecoli_positive_T.tsv")
ecoli_negative_A = TargetRegions("../marginAlign/cPecan/tests/ecoli_null_A.tsv")
ecoli_negative_T = TargetRegions("../marginAlign/cPecan/tests/ecoli_null_T.tsv")
