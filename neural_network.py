...
def classify_with_network2(
        ...
        # which data to use
        forward, motif_start_position, preprocess,
        # training params
    ...
    for i in xrange(iterations):
        labels = []
        # collect the training data, the training labels, and the cross-training data
        ...
        # make the cross-training labels (targets)
        ...
        X, y = shuffle_and_maintain_labels(prc_train, labels)
        ...
        errors = predict(xtrain_data, all_targets, net)
        errors = 1 - errors
        out_file.write("{}\n".format(errors))
